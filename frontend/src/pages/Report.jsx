...
export default function Report() {
  ...
  function buildReportHtml(data) {
    ...
    const summarySection = data.summary
      ? `<p style="font-size:14px;line-height:1.6;color:#333;">${data.summary}</p>`
...
<body>
  ...
  <p style="color:#666;font-size:13px;">Generated: ${dateStr} &mdash; Source: Vignet (vignet.hurlab.org)</p>
  ...
  <div class="footer">
    ...
    <p>Report generated on ${dateStr}</p>
  </div>
</body>
</html>`
  }
